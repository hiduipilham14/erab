...
CREATE TABLE `data_jaringan_barus` (
  ...
  `vol` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `jenis_pipa` bigint unsigned DEFAULT NULL,
  `diameter` bigint unsigned DEFAULT NULL,
...
INSERT INTO `data_jaringan_barus` VALUES (21,'2025-09-12','werwerwer',10,NULL,'23542354','34234',NULL,NULL,'gerg regerg','2025-09-10 19:44:47','2025-09-10 19:44:47');
...
CREATE TABLE `data_penggantian_pipas` (
  ...
  `th_pemasangan_lama` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `th_pemasangan_baru` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `koordinat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vol_lama` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `vol_baru` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `lokasi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `keterangan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `data_rabs` (
  ...
  `no_spk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `pekerjaan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `masa_pemeliharaan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `lokasi` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `rab` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `keterangan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `upah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `jumlah` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `gis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `diameter_jaringan` VALUES (1,8,21,'2025-09-10 19:44:47','2025-09-10 19:44:47'),(2,11,21,'2025-09-10 19:44:47','2025-09-10 19:44:47');
...
INSERT INTO `jenispipa_jaringan` VALUES (1,7,21,'2025-09-10 19:44:47','2025-09-10 19:44:47');
...
CREATE TABLE `spam` (
  ...
  `tanggal` date NOT NULL,
  `koordinat` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `kondisi_existing` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `permasalahan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `tindak_lanjut` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `file_existing` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_permasalahan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_tindak_lanjut` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_spam` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `lokasi` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `spam` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `spam` VALUES (7,'2025-09-19','sdfdfsd','dfsdsfdsf','sdfdsf','sdf sdfdfsd','uploads/1757377350_2516edbf-fb4c-4588-9416-0cf299558353_Go-Biz_20230111_011227.jpeg','uploads/1757377350_4514759.png','uploads/1757377350_Borussia_Dortmund_logo.svg.png','uploads/1757377350_images.jpg','2025-09-08 17:22:30','2025-09-09 05:18:12','sdfsd dsf',NULL),(8,'2025-09-17','fwerwe','rwerwerw','erwerwer','fswde wefwer',NULL,NULL,NULL,NULL,'2025-09-09 05:18:24','2025-09-09 05:36:54','fswewef','kyukyu');
...
INSERT INTO `volume_jaringan` VALUES (1,'34',21,'2025-09-10 19:44:47','2025-09-10 19:44:47'),(2,'345',21,'2025-09-10 19:44:47','2025-09-10 19:44:47');
...
-- Dump completed on 2025-09-11 17:37:46
