...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard/</span> Data Divisi</h4>
                        ...
                        <div class="offcanvas custom-offcanvas-center" id="add-new-record">
                            <div class="offcanvas-header border-bottom">
                                <h5 class="offcanvas-title" id="exampleModalLabel">Tambah Data Divisi</h5>
                        ...
                        <div class="offcanvas custom-offcanvas-center" id="edit-record">
                            <div class="offcanvas-header border-bottom">
                                <h5 class="offcanvas-title" id="editModalLabel">Edit Data Divisi</h5>
                                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                    aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body flex-grow-1">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('div.head-label').html('<h5 class="card-title mb-0">Data Divisi</h5>');
            ...
            $(document).on('click', '.delete-record', function() {
                var id = $(this).data('id');
                var url = "{{ route('data-divisi.destroy', ':id') }}".replace(':id', id);
        ...
        $(document).on('click', '.edit-record', function() {
            var id = $(this).data('id');
            var url = "{{ route('data-divisi.edit', ':id') }}".replace(':id', id);
        ...
        $('#form-edit-record').submit(function(e) {
            ...
            const url = "{{ route('data-divisi.update', ':id') }}".replace(':id', id);
            const $submitBtn = $(this).find('.data-submit');
            const $editModal = $('#edit-record');
            const dataTable = $('#data-divisi-table').DataTable();
