            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard/</span> Data Diameter</h4>
                        ...
                        <div class="offcanvas custom-offcanvas-center" id="add-new-record">
                            <div class="offcanvas-header border-bottom">
                                <h5 class="offcanvas-title" id="exampleModalLabel">Tambah Data Diameter</h5>
                        ...
                        <div class="offcanvas custom-offcanvas-center" id="edit-record">
                            <div class="offcanvas-header border-bottom">
                                <h5 class="offcanvas-title" id="editModalLabel">Edit Data Diameter</h5>
                                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                    aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body flex-grow-1">
    ...
    <script>
        $(document).ready(function() {
            var table = $('#data-divisi-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('data-diameter.index') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
            ...
            $('div.head-label').html('<h5 class="card-title mb-0">Data Diameter</h5>');
            ...
            $(document).on('click', '.delete-record', function() {
                var id = $(this).data('id');
                var url = "{{ route('data-diameter.destroy', ':id') }}".replace(':id', id);
        ...
        $(document).on('click', '.edit-record', function() {
            var id = $(this).data('id');
            var url = "{{ route('data-diameter.edit', ':id') }}".replace(':id', id);
        ...
        $('#form-edit-record').submit(function(e) {
            ...
            var formData = new FormData(this);
            var id = $('#edit_id').val();
            var url = "{{ route('data-diameter.update', ':id') }}".replace(':id', id);
