...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Dashboard/</span> Data Tahun</h4>
                        ...
                        <div class="offcanvas custom-offcanvas-center" id="add-new-record">
                            <div class="offcanvas-header border-bottom">
                                <h5 class="offcanvas-title" id="exampleModalLabel">Tambah Data Tahun</h5>
                            ...
                            <div class="offcanvas-body flex-grow-1">
                                <form class="add-new-record pt-0 row g-2" id="form-add-new-record"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <textarea id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan" rows="3" required></textarea>
                                    </div>
                        ...
                        <div class="offcanvas custom-offcanvas-center" id="edit-record">
                            <div class="offcanvas-header border-bottom">
                                <h5 class="offcanvas-title" id="editModalLabel">Edit Data Tahun</h5>
                                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                                    aria-label="Close"></button>
                            </div>
                            <div class="offcanvas-body flex-grow-1">
                                <form class="edit-record pt-0 row g-2" id="form-edit-record"
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <textarea id="edit_keterangan" name="keterangan" class="form-control" required></textarea>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('div.head-label').html('<h5 class="card-title mb-0">Data Tahun</h5>');
            ...
            $(document).on('click', '.delete-record', function() {
                var id = $(this).data('id');
                var url = "{{ route('data-tahun.destroy', ':id') }}".replace(':id', id);
        ...
        $(document).on('click', '.edit-record', function() {
            var id = $(this).data('id');
            var url = "{{ route('data-tahun.edit', ':id') }}".replace(':id', id);
        ...
        $('#form-edit-record').submit(function(e) {
            ...
            var formData = new FormData(this);
            var id = $('#edit_id').val();
            var url = "{{ route('data-tahun.update', ':id') }}".replace(':id', id);
